<label class="mine-checkbox inline-flex items-center gap-2.5 cursor-pointer">
    ...
    <div
        @class([
            'flex items-center justify-center w-5 h-5 rounded-[6px] border-2 bg-[var(--mine-input-bg)] transition-all duration-180 ease-out shrink-0',
    ...
    >
        <x-mine.icon
            name="check"
            variant="micro"
            class="text-(--mine-checkbox-text)! size-4 transition-all duration-180 ease-out"
        />
    </div>
