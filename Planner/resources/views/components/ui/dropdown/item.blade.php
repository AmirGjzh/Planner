...
@php
    ...
    $variantClasses = match ($variant) {
        'soft' => 'text-neutral-800 dark:text-white hover:bg-slate-200 focus-within:bg-neutral-100 dark:hover:bg-white/5 dark:focus-within:bg-white/5',
        'danger' => 'text-red-600 hover:bg-red-100 dark:hover:bg-red-400/20 dark:text-red-400 focus-within:text-red-600 focus-within:bg-red-50 dark:focus-within:bg-red-400/20 dark:focus-within:text-red-400',
        default => '',
    };
    ...
    $classes = [
        ...
        'w-full px-2 py-1.5 text-sm transition-colors duration-50 text-start',
