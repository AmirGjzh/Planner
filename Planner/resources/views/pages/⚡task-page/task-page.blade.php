            ...
            <div class="flex flex-col bg-gradient-to-r from-slate-50 to-slate-100 w-full flex-2 rounded-lg p-5">
                ...
                <form wire:submit="addTask" class="flex flex-col gap-2">
                    ...
                    <x-ui.field class="flex-3">
                        ...
                        <x-ui.textarea wire:model="task_description" placeholder="Description" leftIcon=""
                            resize="none" />
                ...
                @forelse ($this->tasks as $task)
                    <div wire:key="{{ $task->id }}" class="flex justify-between gap-20 bg-slate-200 shadow-lg rounded-lg py-2 px-4 mb-4">
                        ...
                        <div class="flex flex-col justify-between gap-4">
                            <div class="self-end">
                                <x-ui.switch size="md" wire:click="toggleTask({{ $task->id }})" label="Finished task"
                                    name="" :checked="$task->done" />
                            </div>
