    ...
    >
        ...
        <input
            @class([
                ...
                'border-black/10 focus:border-black/15 focus:ring-neutral-900/60 dark:border-white/15 dark:focus:border-white/20 dark:focus:ring-neutral-100/15' => !$invalid,
