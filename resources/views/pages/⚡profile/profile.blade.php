        ...
        <div class="md:flex-2 flex flex-col">
            <div class="mine-card p-6 sm:p-8 flex flex-col gap-4">
                ...
                <div class="flex justify-between px-2">
                    ...
                    <p class="text-sm font-medium mine-text-secondary max-w-40 min-w-0 truncate">{{ $this->user->gender ? ucfirst($this->user->gender->value) : '—' }}
                    </p>
                </div>
                <div class="flex justify-between px-2">
                    <p class="text-sm font-medium mine-text-secondary">Country</p>
                    <p class="text-sm font-medium mine-text-secondary max-w-40 min-w-0 truncate">{{ $this->countries[$this->user->country] ?? '—' }}
                    </p>
                </div>
            </div>
