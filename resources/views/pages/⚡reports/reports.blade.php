...
<div class="flex-1 px-4 sm:px-8 md:px-16 pb-6 pt-4 flex flex-col">
    ...
    <div class="flex flex-col">
                        ...
                        <x-mine.dropdown group="reports-range" class="w-full flex-1">
                            <x-mine.dropdown.trigger as="div" class="w-full">
                                <div
                                    ...
                                    <x-mine.icon name="calendar" class="size-4" variant="micro" />
                                    <p @class([
        ...
        <div class="flex flex-col mb-6">
            <h2 class="font-semibold text-sm mine-text-primary mb-4">{{ __('Tasks Summary') }}</h2>
        ...
        <div class="flex flex-col mb-10">
            <h2 class="font-semibold text-sm mine-text-primary mb-4">{{ __('Plans Summary') }}</h2>
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                <div class="flex items-center justify-between mine-card p-4">
                    <div class="flex flex-col justify-between gap-4">
